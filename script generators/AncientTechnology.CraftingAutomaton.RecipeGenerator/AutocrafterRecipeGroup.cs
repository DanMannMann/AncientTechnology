    ...
    partial class Program
    {
        public class AutocrafterRecipeGroup
        {
            ...
            public string GetCraftChecker()
            {
                ...
                {
                    sb.AppendLine($"execute as @s at @s if entity @s[tag={recipe.RecipeName}] run function ancient_technology:crafting_automaton/recipes/{recipe.RecipeFamily}/{recipe.RecipeGroup}/{recipe.RecipeName}");
                }
                return sb.ToString();
            }
