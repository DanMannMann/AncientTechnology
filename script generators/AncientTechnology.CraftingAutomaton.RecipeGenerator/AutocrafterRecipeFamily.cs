    ...
    partial class Program
    {
        public class AutocrafterRecipeFamily
        {
            ...
            public string GetCraftChecker()
            {
                ...
                {
                    sb.AppendLine($"execute as @s at @s if entity @s[tag={group.Name}] run function ancient_technology:crafting_automaton/recipes/{Name}/{group.Name}/check_crafts");
                }
                return sb.ToString();
            }
            ...
            public string GetDropChecker()
            {
                ...
                foreach (var group in Groups)
                {
                    sb.AppendLine($"execute as @s at @s if entity @s[tag={group.Name}] run function ancient_technology:crafting_automaton/recipes/{Name}/{group.Name}/drop_items");
                }
                return sb.ToString();
            }
        }
