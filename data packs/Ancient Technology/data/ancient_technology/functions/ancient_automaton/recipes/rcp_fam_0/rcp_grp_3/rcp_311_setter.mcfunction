...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_0', 'rcp_grp_3', 'rcp_311', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~0 ~0 ~-1 Items[4] set value {id:'minecraft:enchanted_golden_apple',Slot:4b,Count:1b}
# slot 3 not used
# slot 4 not used
# slot 5 not used
# slot 6 not used
