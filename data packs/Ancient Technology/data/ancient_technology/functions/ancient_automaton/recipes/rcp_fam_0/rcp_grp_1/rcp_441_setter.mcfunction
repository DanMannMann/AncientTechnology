...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_0', 'rcp_grp_1', 'rcp_441', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~-1 ~ ~-1 Items[4] set value {id:'minecraft:shulker_shell',Slot:4b,Count:1b}
# slot 2 not used
# slot 3 not used
execute as @s at @s run data modify block ~-1 ~0 ~0 Items[4] set value {id:'minecraft:chest',Slot:4b,Count:1b}
# slot 5 not used
# slot 6 not used
execute as @s at @s run data modify block ~-1 ~0 ~1 Items[4] set value {id:'minecraft:shulker_shell',Slot:4b,Count:1b}
# slot 8 not used
# slot 9 not used
