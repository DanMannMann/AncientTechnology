...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_8', 'rcp_grp_1', 'rcp_253', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~-1 ~ ~-1 Items[4] set value {id:'minecraft:carved_pumpkin',Slot:4b,Count:1b}
# slot 2 not used
# slot 3 not used
execute as @s at @s run data modify block ~-1 ~0 ~0 Items[4] set value {id:'minecraft:torch',Slot:4b,Count:1b}
# slot 5 not used
# slot 6 not used
# slot 7 not used
# slot 8 not used
