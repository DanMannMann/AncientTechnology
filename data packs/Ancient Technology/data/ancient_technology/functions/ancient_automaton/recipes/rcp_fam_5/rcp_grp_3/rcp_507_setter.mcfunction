...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_5', 'rcp_grp_3', 'rcp_507', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~-1 ~ ~-1 Items[4] set value {id:'minecraft:fishing_rod',Slot:4b,Count:1b}
# slot 2 not used
# slot 3 not used
# slot 4 not used
execute as @s at @s run data modify block ~0 ~0 ~-0 Items[4] set value {id:'minecraft:warped_fungus',Slot:4b,Count:1b}
# slot 6 not used
# slot 7 not used
# slot 8 not used
# slot 9 not used
