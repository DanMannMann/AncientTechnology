...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_4', 'rcp_grp_3', 'rcp_195', 'ancient_automaton', 'placed', 'installed_crafting']}
...
# slot 2 not used
execute as @s at @s run data modify block ~1 ~0 ~-1 Items[4] set value {id:'minecraft:brick',Slot:4b,Count:1b}
# slot 4 not used
