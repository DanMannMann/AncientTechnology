...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_4', 'rcp_grp_3', 'rcp_19', 'ancient_automaton', 'placed', 'installed_crafting']}
...
# slot 6 not used
execute as @s at @s run data modify block ~-1 ~0 ~1 Items[4] set value {id:'minecraft:stick',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~0 ~-0 ~1 Items[4] set value {id:'minecraft:smooth_stone_slab',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~1 ~-0 ~1 Items[4] set value {id:'minecraft:stick',Slot:4b,Count:1b}
