...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_4', 'rcp_grp_2', 'rcp_458', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~0 ~0 ~-0 Items[4] set value {id:'minecraft:arrow',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~1 ~0 ~-0 Items[4] set value {id:'minecraft:glowstone_dust',Slot:4b,Count:1b}
# slot 7 not used
execute as @s at @s run data modify block ~0 ~-0 ~1 Items[4] set value {id:'minecraft:glowstone_dust',Slot:4b,Count:1b}
# slot 9 not used
