...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_4', 'rcp_grp_0', 'rcp_192', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~-1 ~ ~-1 Items[4] set value {id:'minecraft:flint',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~0 ~0 ~-1 Items[4] set value {id:'minecraft:flint',Slot:4b,Count:1b}
# slot 3 not used
