...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_4', 'rcp_grp_1', 'rcp_457', 'ancient_automaton', 'placed', 'installed_crafting']}
...
# slot 5 not used
# slot 6 not used
execute as @s at @s run data modify block ~-1 ~0 ~1 Items[4] set value {id:'minecraft:soul_sand',Slot:4b,Count:1b}
# slot 8 not used
# slot 9 not used
