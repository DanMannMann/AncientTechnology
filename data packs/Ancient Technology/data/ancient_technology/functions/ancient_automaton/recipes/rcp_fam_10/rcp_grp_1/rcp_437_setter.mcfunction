...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_10', 'rcp_grp_1', 'rcp_437', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~-1 ~ ~-1 Items[4] set value {id:'minecraft:bamboo',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~0 ~0 ~-1 Items[4] set value {id:'minecraft:string',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~1 ~0 ~-1 Items[4] set value {id:'minecraft:bamboo',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~-1 ~0 ~0 Items[4] set value {id:'minecraft:bamboo',Slot:4b,Count:1b}
# slot 5 not used
execute as @s at @s run data modify block ~1 ~0 ~-0 Items[4] set value {id:'minecraft:bamboo',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~-1 ~0 ~1 Items[4] set value {id:'minecraft:bamboo',Slot:4b,Count:1b}
# slot 8 not used
