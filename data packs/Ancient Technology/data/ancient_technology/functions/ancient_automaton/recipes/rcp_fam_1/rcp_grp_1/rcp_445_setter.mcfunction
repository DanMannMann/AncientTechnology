...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_1', 'rcp_grp_1', 'rcp_445', 'ancient_automaton', 'placed', 'installed_crafting']}
...
# slot 3 not used
execute as @s at @s run data modify block ~-1 ~0 ~0 Items[4] set value {id:'#minecraft:logs_that_burn',Slot:4b,Count:1b}
