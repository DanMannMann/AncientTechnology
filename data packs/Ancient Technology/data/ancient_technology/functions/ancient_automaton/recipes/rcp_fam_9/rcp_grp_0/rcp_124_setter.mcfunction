...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_9', 'rcp_grp_0', 'rcp_124', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~-1 ~ ~-1 Items[4] set value {id:'minecraft:cut_sandstone',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~0 ~0 ~-1 Items[4] set value {id:'minecraft:cut_sandstone',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~1 ~0 ~-1 Items[4] set value {id:'minecraft:cut_sandstone',Slot:4b,Count:1b}
# slot 4 not used
# slot 5 not used
# slot 6 not used
# slot 7 not used
