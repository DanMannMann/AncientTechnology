...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_9', 'rcp_grp_3', 'rcp_171', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~-1 ~ ~-1 Items[4] set value {id:'minecraft:dried_kelp_block',Slot:4b,Count:1b}
# slot 2 not used
# slot 3 not used
# slot 4 not used
# slot 5 not used
