...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_9', 'rcp_grp_3', 'rcp_523', 'ancient_automaton', 'placed', 'installed_crafting']}
...
# slot 2 not used
# slot 3 not used
execute as @s at @s run data modify block ~-1 ~0 ~0 Items[4] set value {id:'minecraft:waxed_oxidized_cut_copper',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~0 ~0 ~-0 Items[4] set value {id:'minecraft:waxed_oxidized_cut_copper',Slot:4b,Count:1b}
# slot 6 not used
