...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_7', 'rcp_grp_1', 'rcp_117', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~0 ~0 ~-0 Items[4] set value {id:'minecraft:tripwire_hook',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~1 ~0 ~-0 Items[4] set value {id:'minecraft:string',Slot:4b,Count:1b}
# slot 7 not used
