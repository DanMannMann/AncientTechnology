...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_3', 'rcp_grp_1', 'rcp_453', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~-1 ~ ~-1 Items[4] set value {id:'minecraft:snow_block',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~0 ~0 ~-1 Items[4] set value {id:'minecraft:snow_block',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~1 ~0 ~-1 Items[4] set value {id:'minecraft:snow_block',Slot:4b,Count:1b}
# slot 4 not used
# slot 5 not used
# slot 6 not used
# slot 7 not used
