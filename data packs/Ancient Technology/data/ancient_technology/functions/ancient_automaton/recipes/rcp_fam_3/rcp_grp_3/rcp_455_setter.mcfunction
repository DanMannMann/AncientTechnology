...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_3', 'rcp_grp_3', 'rcp_455', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~0 ~0 ~-0 Items[4] set value {id:'minecraft:soul_sand',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~1 ~0 ~-0 Items[4] set value {id:'minecraft:stick',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~-1 ~0 ~1 Items[4] set value {id:'#minecraft:logs_that_burn',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~0 ~-0 ~1 Items[4] set value {id:'#minecraft:logs_that_burn',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~1 ~-0 ~1 Items[4] set value {id:'#minecraft:logs_that_burn',Slot:4b,Count:1b}
