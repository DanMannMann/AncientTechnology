...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_3', 'rcp_grp_3', 'rcp_59', 'ancient_automaton', 'placed', 'installed_crafting']}
...
# slot 1 not used
execute as @s at @s run data modify block ~0 ~0 ~-1 Items[4] set value {id:'minecraft:blaze_rod',Slot:4b,Count:1b}
# slot 3 not used
