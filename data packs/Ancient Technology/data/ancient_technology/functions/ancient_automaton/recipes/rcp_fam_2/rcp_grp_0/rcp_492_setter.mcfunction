...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_2', 'rcp_grp_0', 'rcp_492', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~-1 ~ ~-1 Items[4] set value {id:'minecraft:stripped_oak_log',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~0 ~0 ~-1 Items[4] set value {id:'minecraft:stripped_oak_log',Slot:4b,Count:1b}
# slot 3 not used
execute as @s at @s run data modify block ~-1 ~0 ~0 Items[4] set value {id:'minecraft:stripped_oak_log',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~0 ~0 ~-0 Items[4] set value {id:'minecraft:stripped_oak_log',Slot:4b,Count:1b}
# slot 6 not used
# slot 7 not used
# slot 8 not used
# slot 9 not used
