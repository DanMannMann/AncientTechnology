...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_2', 'rcp_grp_3', 'rcp_319', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~-1 ~ ~-1 Items[4] set value {id:'minecraft:brown_mushroom',Slot:4b,Count:1b}
execute as @s at @s run data modify block ~0 ~0 ~-1 Items[4] set value {id:'minecraft:red_mushroom',Slot:4b,Count:1b}
