...
data merge entity @s {Tags:['recipe_set', 'rcp_fam_2', 'rcp_grp_1', 'rcp_185', 'ancient_automaton', 'placed', 'installed_crafting']}
...
execute as @s at @s run data modify block ~-1 ~ ~-1 Items[4] set value {id:'minecraft:ender_pearl',Slot:4b,Count:1b}
