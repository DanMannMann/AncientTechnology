...
execute unless block ~ ~ ~ barrel{Items:[{Slot: 10b, id:"minecraft:written_book", tag:{title:"Ancient Tech II"}}]} run tag @s remove anthology_full
execute unless block ~ ~ ~ barrel{Items:[{Slot: 11b, id:"minecraft:written_book", tag:{title:"Ancient Tech III"}}]} run tag @s remove anthology_full
execute unless block ~ ~ ~ barrel{Items:[{Slot: 12b, id:"minecraft:written_book", tag:{title:"Ancient Tech IV"}}]} run tag @s remove anthology_full
execute unless block ~ ~ ~ barrel{Items:[{Slot: 13b, id:"minecraft:written_book", tag:{title:"Ancient Tech V"}}]} run tag @s remove anthology_full
execute unless block ~ ~ ~ barrel{Items:[{Slot: 14b, id:"minecraft:written_book", tag:{title:"Ancient Tech VI"}}]} run tag @s remove anthology_full
execute unless block ~ ~ ~ barrel{Items:[{Slot: 15b, id:"minecraft:written_book", tag:{title:"Ancient Tech VII"}}]} run tag @s remove anthology_full
execute unless block ~ ~ ~ barrel{Items:[{Slot: 16b, id:"minecraft:written_book", tag:{title:"Ancient Tech VIII"}}]} run tag @s remove anthology_full
execute unless block ~ ~ ~ barrel{Items:[{Slot: 22b, id:"minecraft:written_book", tag:{title:"Ancient Tech IX"}}]} run tag @s remove anthology_full