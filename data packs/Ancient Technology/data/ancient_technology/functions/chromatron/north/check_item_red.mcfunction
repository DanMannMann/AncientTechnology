execute as @s at @s if data block ~ ~ ~ Items[{Slot: 4b, id: "minecraft:yellow_dye"}] run function ancient_technology:chromatron/north/result/orange_dye
execute as @s at @s if data block ~ ~ ~ Items[{Slot: 4b, id: "minecraft:white_dye"}] run function ancient_technology:chromatron/north/result/pink_dye
